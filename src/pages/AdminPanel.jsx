...
const TituloSeccion = ({ icono: Icono, texto, badge }) => (
    <div className="flex items-center gap-2 mb-3 shrink-0">
        <Icono size={16} className="text-orange-500" />
        <h3 className="text-sm font-black text-white uppercase tracking-widest">{texto}</h3>
        {badge != null && (
            ...
            <div className="flex-1 min-h-0 grid portrait:grid-rows-2 landscape:grid-cols-2 gap-6">
                <section className="flex flex-col min-h-0">
                    ...
                    <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar pr-1">
                        <div className="grid grid-cols-[repeat(auto-fill,minmax(160px,1fr))] gap-4 content-start pb-4">
                            {mesas.map((mesa) => (
                ...
                <section className="flex flex-col min-h-0 portrait:border-t landscape:border-t-0 landscape:border-l border-slate-800 portrait:pt-4 landscape:pl-6">
                    ...
                    <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar pr-1">
                        {cargandoEntregas ? (
                            ...
                            <div className="grid grid-cols-[repeat(auto-fill,minmax(200px,1fr))] gap-4 content-start pb-4">
                                {entregas.map((e) => (
