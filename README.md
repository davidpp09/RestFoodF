...
flowchart TD
    ...
    Decide -->|MESERO| Mesero[/mesero/]
    Decide -->|COCINA| Cocina[/cocina-panel/]
    Decide -->|ADMIN o DEV| Admin[/admin/]
    Decide -->|CAJERO| AdminCajero[/admin/]
    Decide -->|REPARTIDOR| Entregas[/entregas/]

    Admin --> Personal[/admin/personal/]
    Admin --> Reportes[/admin/reportes/]
    Admin --> Platillos[/admin/platillos/]
